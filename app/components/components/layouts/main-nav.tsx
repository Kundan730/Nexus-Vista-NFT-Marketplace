...
export function MainNav({ items }: MainNavProps) {
  return (
    <div className='hidden gap-6 lg:flex'>
      <Link aria-label='Home' href='/console' className='hidden items-center space-x-1 lg:flex'>
        <Image src='/img/logo/logo7.png' alt='logo' className='h-6 w-6' width={50} height={50} />
